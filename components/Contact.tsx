        ...
        <div className='grid lg:grid-cols-5 gap-8'>
          ...
          <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
            <div className='lg:p-4 h-full'>
              <div>
                <img className='rounded-xl hover:scale-105 easie-in duration-200' src='https://images.unsplash.com/photo-1423666639041-f56000c27a9a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8Y29udGFjdHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60' alt='' />
              </div>
              <div>
                <h2 className='py-2'>Paweł Budnik</h2>
                <p>Full-Stack Developer</p>
                <p className='py-4'>I am available for freelance or full-time positions. Contact me and let's have a chat.</p>
              </div>
              <div>
